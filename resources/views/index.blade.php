  ...
  <body class="d-flex flex-column h-100">
      ...
      <nav class="navbar navbar-expand-lg navbar-light bg-white py-3">
        <div class="container px-5">
          <a class="navbar-brand" href="#"
            ><span class="fw-bolder text-primary">Vivi Intan</span></a
          >
          <button
              ...
              <div class="text-center text-xxl-start">
                ...
                >
                  <div class="text-uppercase">
                    Junior &middot; Mobile &middot; Developer
                  </div>
                </div>
                <div class="fs-3 fw-light text-muted">Hello!</div>
                <h1 class="display-3 fw-bolder mb-5">
                  <span class="text-gradient d-inline"
                    >My Name is Vivi Intan Sari (Vivi)</span
                  >
                </h1>
                <div
            ...
            <div class="col-xxl-8">
              <div class="text-center my-5">
                ...
                <p class="lead fw-light mb-4">
                  My name is Vivi Intan Sari, Junior Web Developer.
                </p>
                <p class="text-muted">
                  ...
                  <div class="row align-items-center gx-5">
                    <div class="col text-center text-lg-start mb-4 mb-lg-0">
                      <div class="bg-light p-4 rounded-4">
                        ...
                        <div class="small fw-bolder">Mobile Developer</div>
                        <div class="small text-muted">
                          Dimata Software House
                        </div>
                        <div class="small text-muted">Bali</div>
                      </div>
                    </div>
                    <div class="col-lg-8">
                      <div>
                        Develop a mobile application for a client in the
                        tourism.
                      </div>
                    </div>
                  </div>
              ...
              <div class="card shadow border-0 rounded-4 mb-5">
                <div class="card-body p-5">
                  <div class="row align-items-center gx-5">
                    <div class="col text-center text-lg-start mb-4 mb-lg-0">
                      <div class="bg-light p-4 rounded-4">
                        ...
                        <div class="mb-2">
                          ...
                          <div class="small text-muted">Surabaya</div>
                        </div>
                    ...
                    <div class="col-lg-8">
                      <div>
                        Study at Telkom University Surabaya majoring in
                        Information System.
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="row align-items-center gx-5">
                    <div class="col text-center text-lg-start mb-4 mb-lg-0">
                      <div class="bg-light p-4 rounded-4">
                        ...
                        <div class="mb-2">
                          <div class="small fw-bolder">SMKN 2 Tabanan</div>
                          <div class="small text-muted">Tabanan, Bali</div>
                        </div>
                        <div class="fst-italic">
                    ...
                    <div class="col-lg-8">
                      <div>
                        Learning software engineering at SMKN 2 Tabanan.
                      </div>
                    </div>
                  </div>
                </div>
            ...
            <div class="col-lg-11 col-xl-9 col-xxl-8">
              ...
              <div class="card overflow-hidden shadow rounded-4 border-0 mb-5">
                <div class="card-body p-0">
                  <div class="d-flex align-items-center">
                    <div class="p-5">
                      <h2 class="fw-bolder">Al Quran Apps</h2>
                      <p>
                        Create an application that can read the Quran and listen
              ...
              <div class="card overflow-hidden shadow rounded-4 border-0">
                <div class="card-body p-0">
                  <div class="d-flex align-items-center">
                    <div class="p-5">
                      <h2 class="fw-bolder">Skulsik UI/UX Design</h2>
                      <p>
                        Create school finder application UI/UX design for
                        students.
                      </p>
                    </div>
                    <img
    ...
    <footer class="bg-white py-4 mt-auto">
      <div class="container px-5">
        ...
        >
          <div class="col-auto">
            <div class="small m-0">Copyright &copy; Vivi 2023</div>
          </div>
          <div class="col-auto">
